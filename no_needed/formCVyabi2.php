...
<body>
    ...
    <div class="wrapper">
        <div class="form">
            ...
            <form action="./test.php" class="myform" method="POST">
    ...
    <div class="formation yarbii">
        ...
        <div class="control-from">
            ...
            <input type="date" name="datedebut_formation[]" >
        </div>
        <div class="control-from">
            <label for="datefin_formation"><i class="fa-solid fa-calendar-days"></i><span>Date fin *</span>  </label>
            <input type="date" name="datefin_formation[]" >
        </div>

        <div class="full-width">
            <label for="description">Description </label>
            <textarea type="text" name="description[]" class="description" required></textarea>
        </div>
    </div>
</div>
<a href="#iiii" id="add-formation" class="btn btn-primary ajouter" >Ajouter une formation</a>
<!--<button id="add-formation" class="btn btn-primary ajouter">Ajouter une formation</button>
-->
    ...
    <div class="wrapper">
        <div class="form">
            ...
            <div class="myform">
                ...
                <button type="submit" name="submit" class="btn btn-success m-auto ">Valider</button>
</form>
        </div>
    </div>
    ...
    document.getElementById('add-formation').addEventListener('click', function() {
        ...
        formation.innerHTML = '<hr>' + '<div class="formation yarbii">' + '<div class="control-from">' +
            '<label for="etablissement"><i class="fa-solid fa-briefcase"></i><span> Etablissement *</span></label>' +
            '<input type="text" name="etablissement[]" placeholder="">' +
            '</div>' +
            '<div class="control-from">' +
            ...
            '<input type="date" name="datedebut_formation[]">' +
            '</div>' +
            '<div class="control-from">' +  '<label for="datefin_formation"><i class="fa-solid fa-calendar-days"></i><span>Date fin *</span>  </label>' +
            '<input type="date" name="datefin_formation[]">' +
            '</div>' +
            '<div class="full-width">' +
            '<label for="description">Description </label>' +
